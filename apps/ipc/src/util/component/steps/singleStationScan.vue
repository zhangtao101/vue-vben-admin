...
// 单工位列表
const singleStationList = ref<any>([34, 35, 37, 40]);
// 禁用扫码的工位列表
const disableScanningCodes = ref<any>([34, 37]);
// 多工位列表
const multiStationList = ref([27, 32, 33, 41]);
...
<template>
  ...
  <Spin :spinning="spinning">
    ...
    <Row :gutter="24" class="my-4">
      <Col :span="8">
        <Button type="primary" @click="clear()" class="w-full">
          {{ $t('common.clear') }}
        </Button>
      </Col>
      <Col :span="8">
        <Button
          type="primary"
          @click="judgement(getTableData(), 1)"

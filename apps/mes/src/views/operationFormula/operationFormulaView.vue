...
const gridOptions: VxeGridProps<any> = {
  ...
  columns: [
    ...
    { field: 'userName', title: '所属工序', minWidth: 150 },
    { field: 'perName', title: '工步名称', minWidth: 150 },
    { field: 'workNumber', title: '工步ID', minWidth: 150 },
    { field: 'operationMode', title: '作业模式', minWidth: 150 },
    { field: 'jobType', title: '作业类型', minWidth: 150 },
    { field: 'functionNotes', title: '功能备注', minWidth: 150 },
    { field: 'version', title: '版本', minWidth: 150 },
    { field: 'founder', title: '创建人', minWidth: 150 },
    {
      field: 'action',
      fixed: 'right',
  ...
  <Page>
    ...
    <Card class="mb-8">
      <Form :model="queryParams" layout="inline">
        ...
        <!-- 所属工序 -->
        <FormItem
          :label="$t('operationFormulaView.affiliatedProcess')"
          style="margin-bottom: 1em"
        >

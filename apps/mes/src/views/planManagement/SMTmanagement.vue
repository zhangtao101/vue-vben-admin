...
const gridOptions: VxeGridProps<any> = {
  ...
  columns: [
    ...
    { field: 'workSheetCode', title: '工单号', minWidth: 100 },
    { field: 'planDateStart', title: '计划时间', minWidth: 130 },
    { field: 'planCode', title: '计划号', minWidth: 100 },
    { field: 'lineName', title: '任务线别', minWidth: 110 },
    {
    ...
    { field: 'sideNo', title: '面号', minWidth: 100 },
    { field: 'workSheetPlanNumber', title: '工单计划数', minWidth: 110 },
    { field: 'workSheetFinishNumber', title: '工单完成数', minWidth: 110 },
    {
      field: 'productName',
      title: '产品名称',
      minWidth: 200,
    ...
    { field: 'subPlanNumber', title: '部件计划数量', minWidth: 110 },
    { field: 'productCode', title: '产品编号', minWidth: 100 },
    { field: 'worksheetCodea', title: 'A工单号', minWidth: 110 },
    { field: 'subProductCode', title: '部件编号', minWidth: 95 },
    { field: 'subPlanCode', title: '部件计划号', minWidth: 110 },
    { field: 'produceUnarrangedNumber', title: '生产未排数', minWidth: 110 },
    { field: 'produceNotFinishNumber', title: '生产未完数', minWidth: 110 },
    { field: 'produceWorkshop', title: '生产车间', minWidth: 100 },
    { field: 'remark', title: '备注', minWidth: 100 },
    { field: 'updateUsername', title: '操作人', minWidth: 100 },
    {
      field: 'updateTime',
      title: '操作时间',
      minWidth: 150,
      slots: {
        default: 'updateTimeSlot',
      },
    },
    {
      field: 'action',
...
function queryData({ page, pageSize }: any) {
  return new Promise((resolve, reject) => {
    ...
    if (params.plannedTime && params.plannedTime.length === 2) {
      params.planDateStart = params.orderDate[0].format('YYYY-MM-DD');
      params.planDateEnd = params.orderDate[1].format('YYYY-MM-DD');
      params.plannedTime = undefined;
    }
    worksheetSearch({
    ...
    <Card class="mb-8">
      <Form :model="queryParams" layout="inline">
        ...
        <FormItem
          ...
          style="margin-bottom: 1em"
        >
          <Input v-model:value="queryParams.lineId" />
        </FormItem>

...
const gridOptions: VxeGridProps<any> = {
  ...
  columns: [
    ...
    {
      field: 'isQualityTest',
      title: $t('storeManagement.inventoryManagement.qualityTest'),
      minWidth: 50,
      slots: { default: 'status' },
    },
    {
      field: 'isContract',
      title: $t('storeManagement.inventoryManagement.contract'),
      minWidth: 50,
      slots: { default: 'status' },
    },
    {
      field: 'isHalf',
      title: $t('storeManagement.inventoryManagement.semiFinished'),
      minWidth: 80,
      slots: { default: 'status' },
    },
    {
      field: 'isZeroStock',
      title: $t('storeManagement.inventoryManagement.zeroStock'),
      minWidth: 80,
      slots: { default: 'status' },
    },

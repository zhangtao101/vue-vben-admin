...
function queryData() {
  const { scadaData, pageName, bindDeviceList }: any = {
    ...
    sharePass: null,
    pageImage:
      '/profile/upload/2025/11/26/file_1764143766196_20251126155606A012.png',
    tenantId: 1,
    tenantName: 'admin',
    delFlag: 0,
    base64: null,
...
const layerStyle = computed(() => {
  const styles = [`transform: scale(${zoomValue.value / 100});`];
  // 缩放
  // 背景颜色

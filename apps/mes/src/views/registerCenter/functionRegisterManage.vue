...
const registerFlagOptions = [
  ...
  {
    color: 'orange',
    label: $t('functionRegisterManage.specifiedAuth'),
    value: 2,
  },
];
...
const registerTriggerOptions = [
  ...
  {
    color: 'green',
    label: $t('functionRegisterManage.realTimeMonitor'),
    value: 2,
  },
    ...
    <Card>
      <Grid>
        ...
        <template #registerTrigger="{ row }">
          <Tag
            :color="optionColor(registerTriggerOptions, row.registerTrigger)"
          >
        ...
        <template #action="{ row }">
          ...
          <Tooltip>
            ...
            <Button class="mr-4" type="link" @click="viewRow(row)">
              <Icon
          ...
          <Tooltip>
            <template #title>
{{
              $t('functionRegisterManage.registerDetail')
            }}
</template>
            <Button
    ...
    >
      ...
      >
        ...
        <DescriptionsItem :label="$t('functionRegisterManage.registerType')">
          <Tag
            :color="optionColor(registerTypeOptions, checkedRow.registerType)"
          >
        ...
        <DescriptionsItem :label="$t('functionRegisterManage.registerFlag')">
          <Tag
            :color="optionColor(registerFlagOptions, checkedRow.registerFlag)"
          >
        ...
        <DescriptionsItem :label="$t('functionRegisterManage.registerTrigger')">
          <Tag
            :color="
              optionColor(registerTriggerOptions, checkedRow.registerTrigger)
            "
          >
    ...
    <Drawer
      ...
      :title="
        checkedRow.id
          ? $t('functionRegisterManage.editInfo')
          : $t('functionRegisterManage.addInfo')
      "
    >
      <Form
        ref="editForm"

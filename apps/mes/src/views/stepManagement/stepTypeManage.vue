...
const paramGridOptions: VxeGridProps<any> = {
  ...
  columns: [
    ...
    {
      field: 'paramCode',
      title: $t('stepTypeManage.paramCode'),
      minWidth: 120,
    },
    {
      field: 'paramName',
      title: $t('stepTypeManage.paramName'),
      minWidth: 150,
    },
    {
      field: 'paramTypeName',
    ...
    {
      field: 'paramCron',
      title: $t('stepTypeManage.paramCron'),
      minWidth: 130,
    },
    {
      field: 'paramUseName',
      title: $t('stepTypeManage.paramUseId'),
      minWidth: 130,
    },
    {
      field: 'action',
...
function getAttributeFlag(attribute: string) {
  return (
    attributeOptions.value.find((item) => item.value === attribute)
      ?.attributeFlag ?? 0
  );
}
...
<template>
  <Page>
    ...
    >
      <!-- 当前选中工步类型基本信息 -->
      <Descriptions :column="2" bordered class="mb-3">
    ...
    >
      <Descriptions :column="1" bordered :title="$t('stepTypeManage.typeInfo')">
        <DescriptionsItem :label="$t('stepTypeManage.functionType')">
    ...
    <Drawer
      ...
      :title="
        checkedTypeRow.id
          ? $t('stepTypeManage.editTypeInfo')
          : $t('stepTypeManage.addTypeInfo')
      "
    >
      <Form
        ref="typeForm"
    ...
    <Drawer
      ...
      :title="
        checkedParam.id
          ? $t('stepTypeManage.editParamInfo')
          : $t('stepTypeManage.addParamInfo')
      "
    >
      <Form
      ...
      >
        <!-- 参数编号 -->
        <FormItem :label="$t('stepTypeManage.paramCode')" name="paramCode">
          <Input
        ...
        <!-- 参数名称 -->
        <FormItem :label="$t('stepTypeManage.paramName')" name="paramName">
          <Input
        ...
        <!-- 参数类型 -->
        <FormItem :label="$t('stepTypeManage.paramType')" name="paramType">
          <Select
        ...
        <!-- 参数标记 -->
        <FormItem :label="$t('stepTypeManage.paramFlag')" name="paramFlag">
          <Select
        ...
        <!-- 参数表达式（逻辑计算时必填） -->
        <FormItem :label="$t('stepTypeManage.paramCron')" name="paramCron">
          <Input
        ...
        <!-- 引用参数（外部引用时必填） -->
        <FormItem :label="$t('stepTypeManage.paramUseId')" name="paramUseId">
          <Select

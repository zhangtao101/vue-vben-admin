...
const gridOptions: VxeGridProps<any> = {
  ...
  columns: [
    ...
    { field: 'batchCode', title: $t('productionDaily.productionBatchNo'), minWidth: 200 },
    { field: 'lineName', title: $t('productionDaily.KilnNo'), minWidth: 200 },
    { field: 'productCode', title: $t('productionDaily.CodeProduct_1'), minWidth: 200 },
    {
      field: 'sctime',
      title: $t('productionDaily.FiringTime'),
      minWidth: 200,
    ...
    {
      field: 'xj',
      title: $t('productionDaily.StopTime_2'),
      minWidth: 150,
      slots: { footer: 'footerData' },
    },
    {

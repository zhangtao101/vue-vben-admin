...
const gridOptions: VxeGridProps<any> = {
  ...
  columns: [
    ...
    { field: 'type', title: $t('productionDaily.EnergyType'), minWidth: 200 },
    ...
    { field: 'stopTrqValue', title: $t('productionDaily.TotalShutdownEnergy'), minWidth: 200 },
    {
    ...
    },
    {
      ...
      children: [
        ...
        { field: 'gytcsy', title: $t('productionDaily.Glaze_1'), minWidth: 150 },

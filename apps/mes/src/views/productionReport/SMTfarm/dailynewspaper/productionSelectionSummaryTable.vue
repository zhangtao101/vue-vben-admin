...
const gridOptions: VxeGridProps<any> = {
  ...
  columns: [
    ...
    { field: 'materialCode', title: $t('productionDaily.Code_4'), minWidth: 200 },
    { field: 'ly', title: $t('productionDaily.M2_9'), minWidth: 200 },
    {
      field: 'lytotal',
      title: $t('productionDaily.GrandTotal'),
      minWidth: 200,
      slots: { footer: 'footerData' },
    },
    {
      field: 'inMaterialCode',
      title: $t('productionDaily.CodeInbound'),
      minWidth: 200,
      slots: { footer: 'footerData' },
    },
    {
      field: 'in',
      title: $t('productionDaily.Inbound'),
      minWidth: 200,
      slots: { footer: 'footerData' },
    },
    {
      field: 'inTotal',
      title: $t('productionDaily.GrandTotalInbound'),
      minWidth: 200,
      slots: { footer: 'footerData' },
    },
    {
      field: 'loss',
      title: $t('productionDaily.profitLoss'),
      minWidth: 200,
      slots: { footer: 'footerData' },
    },
    {

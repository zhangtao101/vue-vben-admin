...
const gridOptions: VxeGridProps<any> = {
  ...
  columns: [
    ...
    {
      field: 'worksheetCode',
      title: $t('supplementaryFeedingOperation.worksheetCode'),
      minWidth: 190,
    },
    {
      field: 'workstationCode',
      title: $t('supplementaryFeedingOperation.workstationCode'),
      minWidth: 150,
    },
    {
      field: 'productCode',
      title: $t('supplementaryFeedingOperation.productCode'),
      minWidth: 150,
    },
    {
      field: 'productName',
      title: $t('supplementaryFeedingOperation.productName'),
      minWidth: 150,
    },
    {
      field: 'planDateStart',
      title: $t('supplementaryFeedingOperation.planStartTime'),
      minWidth: 150,
    },
    {
      field: 'workSheetPlanNumber',
      title: $t('supplementaryFeedingOperation.planNumber'),
      minWidth: 150,
    },
    {
    ...
    {
      field: 'planDateEnd',
      title: $t('supplementaryFeedingOperation.estimatedCompletionTime'),
      minWidth: 150,
    },
    {
      field: 'unit',
      title: $t('supplementaryFeedingOperation.unit'),
      minWidth: 150,
    },
    {
      field: 'state',

...
const gridOptions: VxeGridProps<any> = {
  ...
  columns: [
    ...
    { field: 'unit', title: $t('materialOffset.unit'), minWidth: 150 },
    {
      ...
      title: $t('materialOffset.workOrderStatus'),
      minWidth: 150,
    },
    {
      field: 'reportState',
      ...
      title: $t('materialOffset.reportWorkStatus'),
      minWidth: 150,
    },
    {
      field: 'action',
...
function getStatusText(state: number) {
  switch (state) {
    case -1: {
      return $t('materialOffset.notProduced');
    }
    case 1: {
      return $t('materialOffset.inProduction');
    }
    case 2: {
      return $t('materialOffset.completedOffline');
    }
    case 3: {
      return $t('materialOffset.pausedOffline');
    }
    default: {
      return $t('materialOffset.undefinedState');
    }
  }
}
/**
...
function getReportStateText(state: number) {
  switch (state) {
    case 1: {
      return $t('materialOffset.notReported');
    }
    case 2: {
      return $t('materialOffset.reported');
    }
    default: {
      return $t('materialOffset.undefinedState');
    }
...
const statusTypes = ref([
  {
    label: $t('materialOffset.notProduced'),
    value: -1,
  },
  {
    label: $t('materialOffset.inProduction'),
    value: 1,
  },
  {
    label: $t('materialOffset.completedOffline'),
    value: 2,
  },
  {
    label: $t('materialOffset.pausedOffline'),
    value: 3,
  },
]);
/**
...
const reportStatusTypes = ref([
  {
    label: $t('materialOffset.notReported'),
    value: 1,
  },
  {
    label: $t('materialOffset.reported'),
    value: 2,
  },
]);

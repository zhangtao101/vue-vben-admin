...
const gridOptions: VxeGridProps<any> = {
  ...
  columns: [
    ...
    { field: 'worksheetCode', title: '班组名称', minWidth: 200 }, // 线损对象名称列
    { field: 'batchCode', title: '所属生产线', minWidth: 200 }, // 统计周期列
    { field: 'productCode', title: '用能单元分区', minWidth: 150 }, // 统计时间列
    { field: 'productName', title: '开始时间', minWidth: 150 }, // 线损率列
    { field: 'workstationCode', title: '结束时间', minWidth: 150 }, // 供入电量列
    { field: 'workstationName', title: '备注', minWidth: 150 }, // 供入明细完整率列
    { field: 'processCode', title: '操作', minWidth: 150 }, // 供出电量列
  ],
  height: 500, // 表格高度
  stripe: true, // 启用斑马纹
  sortConfig: {

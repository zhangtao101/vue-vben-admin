...
const gridOptions: VxeGridProps<any> = {
  ...
  columns: [
    ...
    },
    {
      ...
      title: $t('component.workCenterCode'),
      minWidth: 200,
      slots: { footer: 'footerData' },
    },
    {
      field: 'worksCenterName',
      title: $t('component.workCenterName'),
      minWidth: 200,
      slots: { footer: 'footerData' },
    },
    {
      field: 'day',
      title: $t('component.date'),
      minWidth: 200,
      slots: { footer: 'footerData' },
    },
    {
      field: 'cLass',
      title: $t('component.shift'),
      minWidth: 200,
      slots: { footer: 'footerData' },
    },
    {
      field: 'worksheetType',
      title: $t('component.workOrderType'),
      minWidth: 200,
      slots: { footer: 'footerData' },
    },
    {
      field: 'worksheetCode',
      title: $t('component.workOrderNumber'),
      minWidth: 200,
      slots: { footer: 'footerData' },
    },
    {
      field: 'lineName',
      title: $t('component.productBatchNo'),
      minWidth: 200,
      slots: { footer: 'footerData' },
    },
    {
    ...
    {
      field: 'stopTime',
      title: $t('component.kilnStopTime'),
      minWidth: 200,
      slots: { footer: 'footerData' },
    },
    {
      field: 'stopReason',
      title: $t('component.kilnStopReason'),
      minWidth: 200,
      slots: { footer: 'footerData' },
    },
    {
      field: 'stopTrqValue',
      title: $t('component.kilnStopGas'),
      minWidth: 200,
      slots: { footer: 'footerData' },
    },
  ],
